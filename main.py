...
if __name__ == '__main__':
    ...
    # =====Dict=====
    if cfg.if_real_data:
        from leakGAN_instructor.real_data.leakgan_instructor import LeakGANInstructor
        print("I'm importing LeakGANInstructor")
    else:
        from leakGAN_instructor.oracle_data.leakgan_instructor import LeakGANInstructor
    instruction_dict = {
