...
#For sample to be generated you need dis, batch_size that you want and num of samples
#model.sample(cfg.batch_size, cfg.batch_size, self.dis)
"""
...
"""
    ...
    while i <= bin_sequence_length:
        ...
        word_weights = output.squeeze().data.div(args.temperature).exp().cpu() #squeezez into more tractable matrix

        word_weights.index_fill_(0, zero_index, 0) #fills with zero if the index is not there
